...
module sui::validator_tests {
    ...
    // A valid proof of posession must generated using the same account address and protocol public key. 
    // If you change either the VALID_ADDRESS, or the VALID_PUBKEY, you must regenerate the proof of 
    // posession using [test_proof_of_possession] at sui/crates/sui-types/src/unit_tests/crypto_tests.rs
    ...
    fun test_validator_update_metadata_ok() {
        ...
        let ctx = test_scenario::ctx(scenario);
        let init_stake = coin::into_balance(coin::mint_for_testing(10, ctx));
        let new_protocol_pub_key = x"99f25ef61f8032b914636460982c5cc6f134ef1ddae76657f2cbfec1ebfc8d097374080df6fcf0dcb8bc4b0d8e0af5d80ebbff2b4c599f54f42d6312dfc314276078c1cc347ebbbec5198be258513f386b930d02c2749a803e2330955ebd1a10";
        let new_pop = x"b0695ec40ca7c424173ade60def554f5d8e71c113f2fc6333c0cbf8a3622b89b8b89c49bf325c1a25ce7052eb2605257";
